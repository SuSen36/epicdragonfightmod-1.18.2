...
public interface IDragonPatch {
	...
	ClientModel CLIENT_MODEL = new ClientModel(new net.minecraft.resources.ResourceLocation(EpicDragonFight.MODID, "entity/dragon"));
    ...
    LivingMotion getCurrentLivingMotion();
	...
	void setCurrentLivingMotion(LivingMotion motion);

	LivingMotion getCurrentCompositeMotion();

	void setCurrentCompositeMotion(LivingMotion motion);
