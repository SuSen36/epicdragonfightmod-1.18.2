...
public class PatchedPhases {
	...
	public static final EnderDragonPhase<DragonChargePhase> CHARGE = EnderDragonPhase.create(DragonChargePhase.class, "Charge");
	...
	public static final EnderDragonPhase<DragonGroundIdlePhase> GROUND_IDLE = EnderDragonPhase.create(DragonGroundIdlePhase.class, "Ground Idle");
